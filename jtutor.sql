CREATE DATABASE  IF NOT EXISTS `jtutor_new` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `jtutor_new`;
-- MySQL dump 10.13  Distrib 5.7.12, for osx10.9 (x86_64)
--
-- Host: localhost    Database: jtutor_new
-- ------------------------------------------------------
...
INSERT INTO `users` VALUES (2,'admin@localhost',NULL,NULL,NULL,'$2a$10$FuvU7rf.fHZPLZzzkgi6f.zJ.FRmHwHRHu/KB7y5xMadb7SXxFX26','ROLE_ADMIN','8a625d3be28f69d867fdf6755ab7e708','admin');
...
-- Dump completed on 2016-10-27 21:45:02
